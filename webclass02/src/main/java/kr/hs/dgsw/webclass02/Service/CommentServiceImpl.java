...
public class CommentServiceImpl implements CommentService {
    ...
    private void init() {
        User u = userRepository.save(new User("aaa", "aaa@dgsw", "1234",
                "C:/SBEX/webclass10/upload/2020/05/17/c21d69b2-2074-4f32-acab-958320a2bac1_person.png", "person.png"));
        commentRepository.save(new Comment(u.getId(), "hi there 1",
                "C:/SBEX/webclass10/upload/2020/05/17/f68402fe-2527-4a38-afbc-b297b18c2502_content.png", "content.png"));
